...
import asyncio
from lightrag_app.lightrag.utils import logger
import aiofiles
import shutil
import traceback
...
from lightrag_app.lightrag.base import DocProcessingStatus, DocStatus
...
def create_document_routes(
    ...
    async def get_pipeline_status():
        ...
        """
        try:
            from lightrag_app.lightrag.kg.shared_storage import get_namespace_data
