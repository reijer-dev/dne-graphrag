...
PROMPTS["DEFAULT_ENTITY_TYPES"] = ["virus", "disease", "symptom", "drug", "person", "organ"]

PROMPTS["entity_extraction"] = """---Goal---
Given a text document from a medical website and a list of entity types, identify all entities of those types from the text and all relationships among the identified entities.
...
---Steps---
1. Identify all entities. Do not include entities mentioned in the examples. For each identified entity, extract the following information:
- entity_name: Name of the entity, use same language as input text. If English, capitalized the name.
- entity_type: One of the following types: [{entity_types}]
- entity_description: Comprehensive, concise description of the entity's attributes and activities
...
- List up to 5 most important reference sources at the end under "References" sesction. Clearly indicating whether each source is from Knowledge Graph (KG) or Vector Data (DC). In case of the KG, the format is [KG:[chunk_id]], in case of Vector Data, the format is [DC:[URL]]
